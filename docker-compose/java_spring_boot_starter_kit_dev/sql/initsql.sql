...
CREATE TABLE `file` (
                      ...
                      PRIMARY KEY (`idx`),
                      KEY `file_member_idx_idx` (`member_idx`),
                      CONSTRAINT `file_member_idx` FOREIGN KEY (`member_idx`) REFERENCES `user` (`idx`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `memo` (
                      ...
                      PRIMARY KEY (`idx`),
                      KEY `memo_member_idx_idx` (`user_idx`),
                      CONSTRAINT `memo_member_idx` FOREIGN KEY (`user_idx`) REFERENCES `user` (`idx`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-04-29 17:30:34
